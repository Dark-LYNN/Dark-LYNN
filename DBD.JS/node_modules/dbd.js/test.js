// This is an old version of dbd.js that has been edited by @dark-lynn#8688 for her bot akira
...
//ignore this
require("./API.js")
Bot.client.cripto = require("./genID.js")
...
Bot.command({
    name: "add", 
    code: `$addCmdReactions[ðŸž;ðŸ¦;ðŸ‘º;ðŸŽ’;ðŸ¦©;ðŸ·] 
...
Bot.command({
    ...
    code: `
    React 
    $awaitCmdReaction[$authorID;5s;ðŸ˜‚;test1;you didn't react in time]
    $addCmdReactions[ðŸ˜‚]
    `
})
Bot.onMessageUpdate()
...
Bot.command({
    name: "bro", 
    code: `$findMember[$message]
    $onlyForIDs[608358453580136499;502968724207304714;] `
})
...
Bot.command({
    ...
    $onlyForIDs[739591551155437654;608358453580136499;709261464468193322;502968724207304714;600824086943367168;]`, 
    error: `$username, an error occurred!
$error `
})
Bot.command({
  ...
  $textSplit[$eval[$message;yes];Â®Â©Â®Â©Â®Â©Â©]
